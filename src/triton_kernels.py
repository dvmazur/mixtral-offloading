...
@triton.jit
def matmul_4bit_transpose_kernel(
        a_ptr, b_ptr, c_ptr,
    ...
    """
    Compute the matrix multiplication C = A x B^T.
...
def triton_matmul_4bit_transpose(groupsize: int, a: torch.FloatTensor, qweight: torch.IntTensor,
                                 scales: torch.FloatTensor,
                                 zeros: torch.FloatTensor,
                                 bias: Optional[torch.FloatTensor] = None) -> torch.FloatTensor:
    """
    Compute the matrix multiplication C = A x B^T + bias.
    ...
    matmul_4bit_transpose_kernel[grid](
        x, qweight, c,
        scales, zeros,
        M, N, K,
...
@triton.jit
def matmul_2bit_transpose_kernel(
        a_ptr, b_ptr, c_ptr,
        scales_ptr, zeros_ptr,
        M, N, K,
        stride_am, stride_ak,
...
def triton_matmul_2bit_transpose(groupsize: int, a: torch.FloatTensor, qweight: torch.IntTensor, scales: torch.FloatTensor,
    ...
    matmul_2bit_transpose_kernel[grid](
        x, qweight, c,
        scales, zeros,
        M, N, K,
        x.stride(0), x.stride(1),
...
@triton.jit
def matmul_3bit_transpose_kernel(
        a_ptr, b_ptr, c_ptr,
        scales_ptr, zeros_ptr,
        M, N, K,
        stride_am, stride_ak,
...
def triton_matmul_3bit_transpose(groupsize: int, a: torch.FloatTensor, qweight: torch.IntTensor, scales: torch.FloatTensor,
    ...
    matmul_3bit_transpose_kernel[grid](
        x, qweight, c,
        scales, zeros,
        M, N, K,
        x.stride(0), x.stride(1),
